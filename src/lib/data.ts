...
export const calendarEvents = [
  {
    ...
    allDay: false,
    start: (() => {
      const date = new Date(2025, 1, 24); // Feb 24
  ...
  },
  {
    ...
    allDay: false,
    start: (() => {
      const date = new Date(2025, 1, 25); // Feb 25
  ...
  },
  {
    ...
    allDay: false,
    start: (() => {
      const date = new Date(2025, 1, 26); // Feb 26
      date.setHours(12, 0, 0);
      return date;
    })(),
    end: (() => {
  ...
  },
  {
    ...
    allDay: false,
    start: (() => {
      const date = new Date(2025, 1, 27); // Feb 27
      date.setHours(11, 0, 0);
      return date;
    })(),
    end: (() => {
      const date = new Date(2025, 1, 27);
      date.setHours(12, 0, 0);
      return date;
    })(),
  },
  ...
  },
  {
    ...
    allDay: false,
    start: (() => {
      const date = new Date(2025, 1, 28); // Feb 28
      date.setHours(11, 0, 0);
      return date;
    })(),
    end: (() => {
